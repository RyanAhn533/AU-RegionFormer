...
OUT = Path("/home/ajy/AU-RegionFormer/experiments/exp_006_knn_graph_smooth")
...
# Use clean subset as before (consistent with best baseline)
clean_idx = np.where(is_selected == 0)[0]
sel = stratified_sample(clean_idx, y_all, n=30000)
